...
def init_general_nets( input_dim, output_dim, use_gpu=False, vectorized=False):
    init_weights = None
    init_comparators = None
    init_leaves = 8
    action_network = ProLoNet(input_dim=input_dim,
                              ...
                              vectorized=vectorized,
                              device='cuda' if use_gpu else 'cpu')
    value_network = ProLoNet(input_dim=input_dim,
                             output_dim=output_dim,
                             weights=init_weights,
                             comparators=init_comparators,
                             leaves=init_leaves,
